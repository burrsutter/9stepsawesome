...
$ kubectl config set-context 9steps --namespace=myspace # <2>
...
rs-quarkus-demo-mzb6m   1/1     Running   0          10s
rs-quarkus-demo-rzfs2   1/1     Running   0          10s
rs-quarkus-demo-zxbhq   1/1     Running   0          10s
----
