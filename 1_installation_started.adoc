...
[source,bash]
----
$ curl -Lo minikube https://storage.googleapis.com/minikube/releases/v0.35.0/minikube-darwin-amd64
$ chmod +x minikube 
# or
...
minikube config set kubernetes-version v1.12.0 <3>
# minishift addon enable admin-user <4> 
# minishift addon enable anyuid <5>
minikube start -p 9steps <6>
----
...
<3> Setting the Kubernetes version explicitly so you know what you are getting
...
----
$ minikube -p 9steps config view
- cpus: 2
- memory: 6144
- vm-driver: virtualbox
$ minikube -p 9steps status
minikube: Running
cluster: Running
kubectl: Correctly Configured: pointing to minikube-vm at 192.168.99.103
$ minikube -p 9steps ip
192.168.99.103
$ minikube -p 9steps dashboard --url
http://192.168.99.103:30000
$ minikube -p 9steps dashboard
----
...
----
$ minikube -p 9steps docker-env <1>
...
# eval $(minikube -p 9steps docker-env)
# or
$ eval $(minikube -p 9steps docker-env)
# and
...
----
$ minikube -p 9steps service hello-minikube --url
http://192.168.99.103:32403
# and curl it
$ curl $(minikube -p 9steps service hello-minikube --url)
----
