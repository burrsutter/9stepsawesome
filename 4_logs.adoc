...
and if you are running Istio make sure to add the -c to specify your business logic container, instead of the side-car...unless you wish to view the sidecar's logs :-)
